...
function exerciseOne(arrayOfPeople) {
  ...
  arrayOfPeople.map(people => {
    ...
    let titlePerson = document.createElement('h1');
    let subtitlePerson = document.createElement('h2');
    titlePerson.innerText = people.name.toUpperCase();
    subtitlePerson.innerText = people.job;
    divPerson.appendChild(titlePerson);
    divPerson.appendChild(subtitlePerson);
  })
}
/**
 *
...
function exerciseTwo(shopping) {
  ...
  titleList.id = 'title-list';
  titleList.innerText = "List of shopping items";
  divList.appendChild(titleList);
  // add list
  let listDis = document.createElement('ul');
  divList.appendChild(listDis);
  let listUl = document.querySelector("#content ul");
...
function exerciseThree(books) {
  ...
  books.forEach(book => {
    let itemList = document.createElement('li');
    itemList.style.listStyle = 'none';
    itemList.style.flex = 'auto';
    itemList.style.width = 'calc(25% - 51px)';
    itemList.style.margin = '15px';
    itemList.style.padding = '10px';
    itemList.style.minWidth = '350px';
    let listP = document.createElement('p');
    listP.innerText = `${book.title} - ${book.author}`;
    let imgBook = document.createElement('img');
    imgBook.src = bookImg[books.indexOf(book)];
    book.alreadyRead ? itemList.style.backgroundColor = 'green' : itemList.style.backgroundColor = 'red';
    itemList.appendChild(listP);
    itemList.appendChild(imgBook);
    listUl.appendChild(itemList);
...
let people = [
  ...
  //{ name: "Jorge", job: "Junior WebDeveloper"}
];
exerciseOne(people);
